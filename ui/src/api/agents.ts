...
export const agentsApi = {
  ...
  adapterModels: (
    ...
    options?: {
      ...
      /** For ollama_local: probe GET .../models with this base URL (optional). */
    ...
    if (options?.ollamaBaseUrl?.trim()) params.set("baseUrl", options.ollamaBaseUrl.trim());
    if (options?.ollamaApiKey?.trim()) params.set("apiKey", options.ollamaApiKey.trim());
