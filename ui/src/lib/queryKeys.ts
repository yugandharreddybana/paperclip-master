export const queryKeys = {
  github: {
    ...
    repositories: (page: number, pageSize: number, q: string) =>
      ["github", "repositories", page, pageSize, q] as const,
  },
  companies: {
  ...
  agents: {
    ...
    adapterModels: (companyId: string, adapterType: string, environmentId?: string | null, baseUrl?: string) =>
      ["agents", companyId, "adapter-models", adapterType, environmentId ?? null, baseUrl ?? null] as const,
