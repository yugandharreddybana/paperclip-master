...
function OnboardingRoutePage() {
  ...
  const title = matchedCompany
    ? `Continue onboarding for ${matchedCompany.name}`
    : companies.length > 0
      ? "Create another company"
      : "Create your first company";
  const description = matchedCompany
    ? "Run onboarding again to connect GitHub codebases, configure agents, and prepare the AI team draft."
    : companies.length > 0
    ...
    <div className="mx-auto max-w-xl py-10">
      <div className="rounded-lg border border-border bg-card p-6">
        ...
        <div className="mt-4">
          ...
          >
            {matchedCompany ? "Continue Onboarding" : "Start Onboarding"}
          </Button>
        </div>
      </div>
    </div>
